...
const Buyer_Bank_Beneficiary_Accounts = mongoose.Schema({
...
}, { collection: "Buyer_Bank_Beneficiary_Accounts" });
export default mongoose.model('Buyer_Bank_Beneficiary_Accounts', Buyer_Bank_Beneficiary_Accounts);